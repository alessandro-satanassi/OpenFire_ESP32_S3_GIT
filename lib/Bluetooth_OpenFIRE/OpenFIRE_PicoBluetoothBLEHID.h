...
// ====== rimosso ============== #include "HID_Bluetooth.h"
...
class OpenFIRE_PicoBluetoothBLEHID_ {
public:
    OpenFIRE_PicoBluetoothBLEHID_() {
    }
    ...
    // Usage: OpenFIRE_PicoBluetoothBLEHID.setCanSendNowCB(std::bind(&kbd::onCanSendNow, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4));
...
private:
    void packetHandler(uint8_t type, uint16_t channel, uint8_t *packet, uint16_t size) {
        ...
        // aggiunti per non modificare troppo la libreria
        bool __BLEInstallKeyboard = true; //false
        bool __BLEInstallMouse = true;
        bool __BLEInstallJoystick = true; // false
        // ==============================================
