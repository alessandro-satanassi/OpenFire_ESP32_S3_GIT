...
bool OpenFIRE_PicoBluetoothHID_::startHID(const bool hid_boot_device, const char *localName, const char *hidName, uint16_t hidClass, uint8_t hidSubclass, const uint8_t *hidDescriptor, uint16_t hidDescriptorSize) {
    if (_running) {
        return false;
    }
    _running = true;
    ...
    */
    //* =========== RIMOSSO ===========
    //////////////////////////////////////////////hid_create_sdp_record(_hid_service_buffer, 0x10002, &hid_params);
    //=============================== */
    // ========= sotitutito con ===========
    ...
    //* =========== RIMOSSO ===========
    //device_id_create_sdp_record(_device_id_sdp_service_buffer, 0x10004, DEVICE_ID_VENDOR_ID_SOURCE_BLUETOOTH, BLUETOOTH_COMPANY_ID_BLUEKITCHEN_GMBH, 1, 1);
    //=============================== */
    // ========= sotitutito con ===========  
    ...
    //_hci_event_callback_registration.callback = PACKETHANDLERCB(OpenFIRE_PicoBluetoothHID_, packetHandler);
    //hci_add_event_handler(&_hci_event_callback_registration);

    // register for HID events
    hid_device_register_packet_handler(PACKETHANDLERCB(OpenFIRE_PicoBluetoothHID_, packetHandler));
