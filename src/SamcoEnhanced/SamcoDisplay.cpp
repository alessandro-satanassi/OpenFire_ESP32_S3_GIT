        ...
        if(bitRead(SamcoPreferences::pins.pPeriphSCL, 1) && bitRead(SamcoPreferences::pins.pPeriphSDA, 1)) {
            ...
            if(bitRead(SamcoPreferences::pins.pPeriphSCL, 0) && !bitRead(SamcoPreferences::pins.pPeriphSDA, 0)) {
                // SDA/SCL are indeed on verified correct pins
                  ...
                  Wire1.setPins(SamcoPreferences::pins.pPeriphSDA, SamcoPreferences::pins.pPeriphSCL); // MODIFICATO
                #else //rp2040
                  Wire1.setSDA(SamcoPreferences::pins.pPeriphSDA); //commentato MEOTODO NON ESISTE
                  Wire1.setSCL(SamcoPreferences::pins.pPeriphSCL); //commentato MEOTODO NON ESISTE
                #endif
            ...
            if(bitRead(SamcoPreferences::pins.pPeriphSCL, 0) && !bitRead(SamcoPreferences::pins.pPeriphSDA, 0)) {
                // SDA/SCL are indeed on verified correct pins
                #ifdef ARDUINO_ESP32S3_DEV 
                  Wire.setPins(SamcoPreferences::pins.pPeriphSDA, SamcoPreferences::pins.pPeriphSCL); // MODIFICATO
                #else //rp2040  
                  Wire.setSDA(SamcoPreferences::pins.pPeriphSDA); //commentato MEOTODO NON ESISTE
                  Wire.setSCL(SamcoPreferences::pins.pPeriphSCL); //commentato MEOTODO NON ESISTE
                #endif
...
void ExtDisplay::TopPanelUpdate(const char textPrefix[7], const char textInput[16])
{
    if(displayValid) {
